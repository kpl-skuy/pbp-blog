                                ...
                                <div class="dplay-tbl-cell color-white mtb-30">
                                    <div class="mx-w-400x">
                                        ...
                                        <h6><a class="plr-20 btn-brdr-grey color-white"
                                               href="/post/detail/<?= $pt1["slug"] ?>"><b>Continue Reading</b></a></h6>
                                    </div><!-- mx-w-200x -->
                                </div><!-- dplay-tbl-cell -->
                            </div><!-- dplay-tbl -->
                        </div><!-- col-sm-6 -->
                        ...
                        <div class="abs-blr pos-sm-static">
                            <div class="row pos-relative mt-50 all-scroll">
                                ...
                                <div class="col-md-10">
                                    ...
                                    <div class="swiper-container oflow-visible" data-slide-effect="slide"
                                         data-autoheight="false" data-swiper-speed="500" data-swiper-margin="25"
                                         data-swiper-slides-per-view="2" data-swiper-breakpoints="true"
                                         data-scrollbar="true" data-swiper-loop="false"
                                        ...
                                        <div class="swiper-wrapper">
                                            ...
                                            <?php foreach ($postterbaru5 as $pt5) : ?>
                                                <div class="swiper-slide">
                                                    <div class="bg-white">
                                                        <img src="/assets/img/post/<?= $pt5["file_gambar"] ?>"
                                                             alt="<?= $pt5["judul"] ?>"
                                                             style="objec-fit:cover;height:180px;width:100%">

                                                        <div class="plr-25 ptb-15">
                                                            <h5 class="color-ash"><b><?= ucfirst($pt5["nama"]) ?></b>
                                                            </h5>
                                                            <h4 class="mtb-10" title="<?= $pt5["judul"] ?>">
                                                                <a href="/post/detail/<?= $pt5["slug"] ?>"><b><?= crop_string($pt5["judul"], 40) ?></b></a>
                                                            </h4>
                                                            <ul class="list-li-mr-10 color-lt-black">
                                                                <li>
                                                                    <i class="mr-5 font-12 far fa-calendar"></i><?= time_ago($pt5["tgl_insert"]) ?>
                                                                </li>
                                                                <li>
                                                                    <i class="mr-5 font-12 far fa-comments"></i><?= $this->fungsi->sumKomentarInOnePost($pt5["idpost"]) ?>
                                                                </li>
                                                            </ul>
                                                        </div><!-- hot-news -->
                                                    </div><!-- hot-news -->
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-12 ptb-50 pr-30 pr-md-15">
                    ...
                    <div class="row">
                                        ...
                                        <div class="sided-half sided-xs-half h-100 bg-white">
                                            ...
                                            <div class="s-left w-50 w-xs-100 h-100 h-xs-50 pos-relative">
                                                <img src="/assets/img/post/<?= $p["file_gambar"] ?>"
                                                     style="object-fit:cover; width:100%;height:100%"></img>
                                            </div>
                        ...
                        <?php else : ?>
                            <div class="col-12">
                                <div class="alert alert-warning">Maaf pencarian artikel dengan kata
                                    kunci <?= $keyword ?> tidak ditemukan
                                </div>
                            </div>
                        <?php endif ?>
