...
<?php $this->fungsi = new App\Libraries\Fungsi(); ?>
    <div class="flash-data" data-text="<?= session()->getFlashdata('text'); ?>"
         ...
         data-icon="<?= session()->getFlashdata('icon'); ?>"></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-sm-8 col-md-8 col-lg-6 col-xl-6">
                            ...
                            <div class="bg-white p-40 psm-30">
                                ...
                                <h2 class="mt-20 lh-1-2" title="<?= $post["judul"] ?>">
                                    <b><?= crop_string($post["judul"], 120) ?></b></h2>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-lg-8 ptb-50 pr-30 pr-md-15">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            ...
                            <div class="sided-70x">
                                ...
                                <div class="s-right">
                                    <p class="ptb-20 color-ash"><b><?= ucfirst($penulis["nama"]) ?> <br>
                                            on <?= tanggal($post["tgl_insert"]) ?> <?= month($post["tgl_insert"]) ?> <?= tahun($post["tgl_insert"]) ?>
                                            at <?= pukul($post["tgl_insert"]) ?> </b></p>
                                </div>
                            </div><!-- sided-80x-->
                        </div><!-- col-md-6-->
                    ...
                    <p class="mt-40 mt-sm-10">
                        <img src="/assets/img/post/<?= $post["file_gambar"] ?>" alt="<?= $post["judul"] ?>"
                    ...
                    <ul class="tag mtb-50">
                        <?php foreach ($allkategori as $ak) : ?>
                            <li class="mb-2"><a
                                        href="/post/category/<?= strtolower($ak["nama"]) ?>"><b><?= $ak["nama"] ?></b></a>
                            </li>
                        <?php endforeach ?>
                    </ul>
                                ...
                                <div class=" col-sm-6 col-md-6 col-lg-6 col-xl-4 mb-30">
                                    <div class="card h-100 min-h-350x">
                                        <div class="bg-white h-100">
                                            ...
                                            <div class="h-50 bg-10"
                                                 style="background-image:url(/assets/img/post/<?= $sp["file_gambar"] ?>);object-fit:cover"></div>
                                                ...
                                                <div class="dplay-tbl">
                                                    <div class="dplay-tbl-cell">
                                                        ...
                                                        <h4 class="mtb-10" title="<?= $sp["judul"] ?>">
                                                            <a href="/post/detail/<?= $sp["slug"] ?>"><b><?= ucfirst(crop_string($sp["judul"], 40)) ?></b></a>
                                                        </h4>
                                                        <ul class="list-li-mr-10 color-lt-black">
                                                            <li>
                                                                <i class="mr-5 font-12 ion-ios-calendar-outline"></i><?= tgl_indo($sp["tgl_insert"]) ?>
                                                            </li>
                                                            <li>
                                                                <i class="mr-5 font-12 ion-ios-chatbubble-outline"></i><?= $this->fungsi->sumKomentarInOnePost($sp["idpost"]) ?>
                                                            </li>
                                                        </ul>
                                    ...
                                    <div class="row">
                                        <div class="col-9 col-lg-9 col-xl-6">
                                            ...
                                            <div class="sided-70x">
                                                ...
                                                <div class="s-right">
                                                    <p class="ptb-5 color-ash"><b><?= ucfirst($k["nama"]) ?>
                                                            on <?= month($k["tgl_insert"]) ?> <?= tanggal($k["tgl_insert"]) ?>
                                                            , <?= tahun($k["tgl_insert"]) ?>
                                                            at <?= pukul($k["tgl_insert"]) ?></b></p>
                                                </div>
                                            </div><!-- sided-80x-->
                                        </div><!-- col-md-6-->
                    ...
                    <?php if (session()->get('idpenulis')) : ?>
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-8">
                                <form class="form-block form-h-55 form-plr-20 form-bg-white" action="/komentar/save"
                                      method="post">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 mb-30">
                                            <input type="text" placeholder="Nama"
                                                   value="<?= $this->fungsi->getPenulis(session()->get('idpenulis'))["nama"] ?>"
                                                   readonly>
                                        </div>

                                        <div class="col-sm-6 mb-30">
                                            <input type="text" placeholder="Email"
                                                   value="<?= session()->get('emailPenulis') ?>" readonly>
                                        </div>

                                        <div class="col-sm-12 mb-30">
                                            <textarea
                                                    class="ptb-20 min-h-200x <?= $validation->hasError('isi') ? 'is-invalid' : '' ?>"
                                                    placeholder="Isi komentar" name="isi"><?= old('isi') ?></textarea>
                                            <span class="invalid-feedback"><?= $validation->getError('isi') ?></span>
                                        </div>

                                    </div>
                                    <button class="btn-b-lg btn-brdr-grey plr-25 color-ash" type="submit"><b>Post
                                            Comment</b></button>
                    ...
                    <?php else : ?>
                        <div class="row">
                            <div class="col">
                                <button class="btn btn-primary shadow" data-toggle="modal" data-target="#komentarmodal">
                                    Beri Komentar
                                </button>
                            </div>
                        </div>
                                ...
                                <div class="mb-50">
                                    ...
                                    <?php foreach ($postterbaru4 as $pt4) : ?>
                                        <div class="sided-80x mb-20">
                                            <div class="s-left">
                                                <img src="/assets/img/post/<?= $pt4["file_gambar"] ?>"
                                                     alt="<?= $pt4["judul"] ?>" alt="<?= $pt4["file_gambar"] ?>">
                                            </div><!-- s-left -->
                                            <div class="s-right" title="<?= $pt4["judul"] ?>">
                                                <h5 class="pt-5"><a
                                                            href="/post/detail/<?= $pt4["slug"] ?>"><b><?= ucfirst(crop_string($pt4["judul"], 50)) ?></b></a>
                                                </h5>
                                            </div><!-- s-left -->
                                        </div><!-- sided-80x -->
                                    <?php endforeach ?>
